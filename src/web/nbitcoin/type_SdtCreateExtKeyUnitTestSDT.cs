...
namespace GeneXus.Programs.nbitcoin
{
	...
	[XmlType(TypeName="CreateExtKeyUnitTestSDT" , Namespace="distributedcryptography" )]
	[Serializable]
	...
	[DataContract(Name=@"CreateExtKeyUnitTestSDT", Namespace="distributedcryptography")]

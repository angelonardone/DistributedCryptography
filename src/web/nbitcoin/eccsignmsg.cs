...
namespace GeneXus.Programs.nbitcoin {
   public class eccsignmsg : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         /* User Code */
         	byte[] byteSignature = privateKey.SignCompact(msgHash).Signature;
         /* User Code */
          	var val = NBitcoin.DataEncoders.Encoders.Hex.EncodeData(byteSignature);
         /* User Code */
          AV10val = val;
         AV12signature = StringUtil.Trim( AV10val);
         /* User Code */
         	}
         /* User Code */
             catch (Exception ex)

...
namespace GeneXus.Programs {
   public class desktopappservicesrestdeletemesagepost : GXProcedure
   {
      public desktopappservicesrestdeletemesagepost( )
      {
      ...
      public desktopappservicesrestdeletemesagepost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtdeleteMesage__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtdeleteMesage__postOutput aP3_deleteMesage__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV10deleteMesage__postOutputOUT = new SdtdeleteMesage__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_deleteMesage__postOutputOUT=this.AV10deleteMesage__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_deleteMesage__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV10deleteMesage__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV10deleteMesage__postOutputOUT = new SdtdeleteMesage__postOutput(context);
      ...
      private SdtdeleteMesage__postInput AV8body ;
      private SdtdeleteMesage__postOutput AV10deleteMesage__postOutputOUT ;
      ...
      private SdtdeleteMesage__postOutput aP3_deleteMesage__postOutputOUT ;

...
namespace GeneXus.Programs {
   public class gxexplorerservicesrestsendrawtransactionpost : GXProcedure
   {
      public gxexplorerservicesrestsendrawtransactionpost( )
      {
      ...
      public gxexplorerservicesrestsendrawtransactionpost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtSendRawTransaction__postInput aP1_body ,
                           out SdtSendRawTransaction__postOutput aP2_SendRawTransaction__postOutputOUT ,
                           ...
                           out bool aP4_IsSuccess )
      {
         ...
         this.AV21SendRawTransaction__postOutputOUT = new SdtSendRawTransaction__postOutput(context) ;
         this.AV20HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV19IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP2_SendRawTransaction__postOutputOUT=this.AV21SendRawTransaction__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP3_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, out aP2_SendRawTransaction__postOutputOUT, out aP3_HttpMessage, out aP4_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV11localVarPath = "/SendRawTransaction";
         ...
         if ( AV15localVarStatusCode == 200 )
         {
            ...
            AV21SendRawTransaction__postOutputOUT.FromJSonString(AV14localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV21SendRawTransaction__postOutputOUT = new SdtSendRawTransaction__postOutput(context);
      ...
      private SdtSendRawTransaction__postOutput aP2_SendRawTransaction__postOutputOUT ;
      ...
      private SdtSendRawTransaction__postInput AV8body ;
      ...
      private SdtSendRawTransaction__postOutput AV21SendRawTransaction__postOutputOUT ;
   }

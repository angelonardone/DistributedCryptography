...
namespace GeneXus.Programs {
   public class desktopappservicesrestupdategrouppost : GXProcedure
   {
      public desktopappservicesrestupdategrouppost( )
      {
      ...
      public desktopappservicesrestupdategrouppost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtupdateGroup__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtupdateGroup__postOutput aP3_updateGroup__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV10updateGroup__postOutputOUT = new SdtupdateGroup__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_updateGroup__postOutputOUT=this.AV10updateGroup__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_updateGroup__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV10updateGroup__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV10updateGroup__postOutputOUT = new SdtupdateGroup__postOutput(context);
      ...
      private SdtupdateGroup__postOutput aP3_updateGroup__postOutputOUT ;
      ...
      private SdtupdateGroup__postInput AV8body ;
      private SdtupdateGroup__postOutput AV10updateGroup__postOutputOUT ;

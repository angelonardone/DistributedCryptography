...
namespace GeneXus.Programs {
   public class desktopappservicesrestcreatecontactpost : GXProcedure
   {
      public desktopappservicesrestcreatecontactpost( )
      {
      ...
      public desktopappservicesrestcreatecontactpost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtcreateContact__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtcreateContact__postOutput aP3_createContact__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV23createContact__postOutputOUT = new SdtcreateContact__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_createContact__postOutputOUT=this.AV23createContact__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_createContact__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV12localVarPath = "/createContact";
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV23createContact__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV23createContact__postOutputOUT = new SdtcreateContact__postOutput(context);
      ...
      private SdtcreateContact__postOutput aP3_createContact__postOutputOUT ;
      ...
      private SdtcreateContact__postInput AV8body ;
      private SdtcreateContact__postOutput AV23createContact__postOutputOUT ;

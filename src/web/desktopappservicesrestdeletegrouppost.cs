...
namespace GeneXus.Programs {
   public class desktopappservicesrestdeletegrouppost : GXProcedure
   {
      public desktopappservicesrestdeletegrouppost( )
      {
      ...
      public desktopappservicesrestdeletegrouppost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtdeleteGroup__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtdeleteGroup__postOutput aP3_deleteGroup__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV10deleteGroup__postOutputOUT = new SdtdeleteGroup__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_deleteGroup__postOutputOUT=this.AV10deleteGroup__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_deleteGroup__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV10deleteGroup__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV10deleteGroup__postOutputOUT = new SdtdeleteGroup__postOutput(context);
      ...
      private SdtdeleteGroup__postInput AV8body ;
      private SdtdeleteGroup__postOutput AV10deleteGroup__postOutputOUT ;
      ...
      private SdtdeleteGroup__postOutput aP3_deleteGroup__postOutputOUT ;

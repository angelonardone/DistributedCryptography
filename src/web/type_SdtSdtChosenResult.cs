...
namespace GeneXus.Programs
{
	...
	public class SdtSdtChosenResult : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.SdtSdtChosenResultItem> gxTpr_Chosenresult_GXBaseCollection
		{
			get {
				if ( gxTv_SdtSdtChosenResult_Chosenresult == null )
				{
					gxTv_SdtSdtChosenResult_Chosenresult = new GXBaseCollection<GeneXus.Programs.SdtSdtChosenResultItem>( context, "SdtChosenResultItem", "");
				}
		...
		[XmlIgnore]
		public GXBaseCollection<GeneXus.Programs.SdtSdtChosenResultItem> gxTpr_Chosenresult
		{
			get {
				if ( gxTv_SdtSdtChosenResult_Chosenresult == null )
				{
		...
		protected GXBaseCollection<GeneXus.Programs.SdtSdtChosenResultItem> gxTv_SdtSdtChosenResult_Chosenresult = null;  
	...
	public class SdtSdtChosenResult_RESTInterface : GxGenericCollectionItem<SdtSdtChosenResult>, System.Web.SessionState.IRequiresSessionState
	{
		...
		public  GxGenericCollection<GeneXus.Programs.SdtSdtChosenResultItem_RESTInterface> gxTpr_Chosenresult
		{
			get { 
				if (sdt.ShouldSerializegxTpr_Chosenresult_GXBaseCollection_Json())
					return new GxGenericCollection<GeneXus.Programs.SdtSdtChosenResultItem_RESTInterface>(sdt.gxTpr_Chosenresult);
				else
					return null;

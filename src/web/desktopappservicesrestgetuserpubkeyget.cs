...
namespace GeneXus.Programs {
   public class desktopappservicesrestgetuserpubkeyget : GXProcedure
   {
      public desktopappservicesrestgetuserpubkeyget( )
      {
      ...
      public desktopappservicesrestgetuserpubkeyget( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           ...
                           out SdtgetUserPubKey__getOutput aP3_getUserPubKey__getOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV8Username = aP1_Username;
         this.AV9oAuthGXGAM = aP2_oAuthGXGAM;
         this.AV10getUserPubKey__getOutputOUT = new SdtgetUserPubKey__getOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_getUserPubKey__getOutputOUT=this.AV10getUserPubKey__getOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_Username, aP2_oAuthGXGAM, out aP3_getUserPubKey__getOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV12localVarPath = "/getUserPubKey";
         ...
         AV14localVarQueryParams.Set("Username", new GeneXus.Programs.openapicommon.varchartojsonformat(context).executeUdp(  AV8Username));
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV10getUserPubKey__getOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV10getUserPubKey__getOutputOUT = new SdtgetUserPubKey__getOutput(context);
      ...
      private SdtgetUserPubKey__getOutput AV10getUserPubKey__getOutputOUT ;
      ...
      private SdtgetUserPubKey__getOutput aP3_getUserPubKey__getOutputOUT ;

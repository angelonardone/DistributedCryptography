...
namespace GeneXus.Programs {
   public class desktopappservicesrestgetusercontactsget : GXProcedure
   {
      public desktopappservicesrestgetusercontactsget( )
      {
      ...
      public desktopappservicesrestgetusercontactsget( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           ...
                           out SdtgetUserContacts__getOutput aP2_getUserContacts__getOutputOUT ,
                           ...
                           out bool aP4_IsSuccess )
      {
         ...
         this.AV9getUserContacts__getOutputOUT = new SdtgetUserContacts__getOutput(context) ;
         this.AV20HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV19IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP2_getUserContacts__getOutputOUT=this.AV9getUserContacts__getOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP3_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_oAuthGXGAM, out aP2_getUserContacts__getOutputOUT, out aP3_HttpMessage, out aP4_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV11localVarPath = "/getUserContacts";
         ...
         if ( AV15localVarStatusCode == 200 )
         {
            ...
            AV9getUserContacts__getOutputOUT.FromJSonString(AV14localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV9getUserContacts__getOutputOUT = new SdtgetUserContacts__getOutput(context);

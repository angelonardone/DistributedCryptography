...
namespace GeneXus.Programs {
   public class gxexplorerservicesrestgetrawtransactionget : GXProcedure
   {
      public gxexplorerservicesrestgetrawtransactionget( )
      {
      ...
      public gxexplorerservicesrestgetrawtransactionget( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV11localVarPath = "/GetRawTransaction";

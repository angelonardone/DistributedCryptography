...
namespace GeneXus.Programs.distcrypt {
   public class anonymousdesktopappiptestnet : GXProcedure
   {
      public anonymousdesktopappiptestnet( )
      {
      ...
      public anonymousdesktopappiptestnet( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         Gxm1sdt_identityprovider.gxTpr_Identityproviderhost = "auth-testnet.distributedcryptography.com";

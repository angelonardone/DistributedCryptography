...
namespace GeneXus.Programs.wallet {
   public class viewnote : GXDataArea
   {
      public viewnote( )
      {
      ...
      public viewnote( IGxContext context )
      {
      ...
      protected void WB2V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTexnote_Internalname, lblTexnote_Caption, "", "", lblTexnote_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 2, "HLP_Wallet/ViewNote.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202573011565986", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wallet/viewnote.js", "?202573011565988", false, true);
         }
      ...
      {
         lblTexnote_Internalname = "TEXNOTE";
      ...
      private string lblTexnote_Internalname ;
      private string lblTexnote_Caption ;
      private string lblTexnote_Jsonclick ;
      private string sEvt ;

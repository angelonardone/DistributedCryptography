...
namespace GeneXus.Programs.wallet {
   public class getlogindistcrypt : GXProcedure
   {
      public getlogindistcrypt( )
      {
      ...
      public getlogindistcrypt( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV9keyInfo.FromJSonString(AV8WebSession.Get("LoginDistCryptKey"), null);
         cleanup();
      }

...
namespace GeneXus.Programs.wallet {
   public class configreunostrservers : GXDataArea
   {
      public configreunostrservers( )
      {
      ...
      public configreunostrservers( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wallet.configreunostrservers.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ConfigreuNostrServers");
         ...
         GXUtil.WriteLogInfo("wallet\\configreunostrservers:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("wallet.configreunostrservers.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Wallet.ConfigreuNostrServers" ;
      }

      public override string GetPgmdesc( )
      {
         return "Configreu Nostr Servers" ;
      }
      ...
      protected void WB230( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCtlport_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5oneConnParameter.gxTpr_Port), 6, 0, ".", "")), StringUtil.LTrim( ((edtavCtlport_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5oneConnParameter.gxTpr_Port), "ZZZZZ9") : context.localUtil.Format( (decimal)(AV5oneConnParameter.gxTpr_Port), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlport_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCtlport_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Wallet/ConfigreuNostrServers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCtltimeoutmiliseconds_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5oneConnParameter.gxTpr_Timeoutmiliseconds), 6, 0, ".", "")), StringUtil.LTrim( ((edtavCtltimeoutmiliseconds_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5oneConnParameter.gxTpr_Timeoutmiliseconds), "ZZZZZ9") : context.localUtil.Format( (decimal)(AV5oneConnParameter.gxTpr_Timeoutmiliseconds), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,28);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtltimeoutmiliseconds_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCtltimeoutmiliseconds_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Wallet/ConfigreuNostrServers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttConfirm_Internalname, "", "Confirm", bttConfirm_Jsonclick, 5, "Confirm", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRM\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ConfigreuNostrServers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttResotredefault_Internalname, "", "Resotre Default", bttResotredefault_Jsonclick, 5, "Resotre Default", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'RESOTRE DEFAULT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ConfigreuNostrServers.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancel_Internalname, "", "Cancel", bttCancel_Jsonclick, 5, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CANCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ConfigreuNostrServers.htm");
            GxWebStd.gx_div_end( context, "end", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START232( )
      {
         ...
         Form.Meta.addItem("description", "Configreu Nostr Servers", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP230( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLogError("wallet\\configreunostrservers:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024111513324821", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/configreunostrservers.js", "?2024111513324821", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Configreu Nostr Servers";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GXV4","fld":"CTLSECURE"},{"av":"cmbavCtlconnectiontype"},{"av":"GXV1","fld":"CTLCONNECTIONTYPE"}]}""");
         setEventMetadata("'CONFIRM'","""{"handler":"E12232","iparms":[{"av":"AV5oneConnParameter","fld":"vONECONNPARAMETER"}]}""");

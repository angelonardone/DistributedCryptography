   ...
   public class multyaddress : GXWebComponent
   {
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            AV35addresImage_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV35addresImage))&&String.IsNullOrEmpty(StringUtil.RTrim( AV55Addresimage_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV35addresImage)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV35addresImage)) ? AV55Addresimage_GXI : context.PathToRelativeUrl( AV35addresImage));
            GxWebStd.gx_bitmap( context, imgavAddresimage_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, 1, 250, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, AV35addresImage_IsBlob, false, context.GetImageSrcSet( sImgUrl), "HLP_Wallet/MultyAddress.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTotalbalance_Internalname, StringUtil.LTrim( StringUtil.NToC( AV27totalBalance, 18, 8, ".", "")), StringUtil.LTrim( ((edtavTotalbalance_Enabled!=0) ? context.localUtil.Format( AV27totalBalance, "ZZZZZZZZ9.99999999") : context.localUtil.Format( AV27totalBalance, "ZZZZZZZZ9.99999999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','8');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','8');"+";gx.evt.onblur(this,17);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTotalbalance_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTotalbalance_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Wallet/MultyAddress.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTransactionscount_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV29transactionsCount), 10, 0, ".", "")), StringUtil.LTrim( ((edtavTransactionscount_Enabled!=0) ? context.localUtil.Format( (decimal)(AV29transactionsCount), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV29transactionsCount), "ZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,21);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTransactionscount_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTransactionscount_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Wallet/MultyAddress.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttSend_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(29), 2, 0)+","+"null"+");", "Send", bttSend_Jsonclick, 7, "Send", "", StyleString, ClassString, bttSend_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11091_client"+"'", TempTags, "", 2, "HLP_Wallet/MultyAddress.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "ADDRESSGRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "'GET KEY INFO'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "'GET KEY INFO'") == 0 ) )
                           {
                              ...
                              AV44GXV1 = (int)(nGXsfl_29_idx+ADDRESSGRID_nFirstRecordOnPage);
                              if ( ( AV23SDTAddressHistory.Count >= AV44GXV1 ) && ( AV44GXV1 > 0 ) )
                              {
                                 AV23SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV23SDTAddressHistory.Item(AV44GXV1));
      ...
      protected void STRUP090( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            while ( nGXsfl_29_fel_idx < nRC_GXsfl_29 )
            {
               ...
               AV44GXV1 = (int)(nGXsfl_29_fel_idx+ADDRESSGRID_nFirstRecordOnPage);
               if ( ( AV23SDTAddressHistory.Count >= AV44GXV1 ) && ( AV44GXV1 > 0 ) )
               {
                  AV23SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV23SDTAddressHistory.Item(AV44GXV1));
                  AV10firstLink = cgiGet( edtavFirstlink_Internalname);
      ...
      private void E15092( )
      {
         ...
         returnInSub = false;
         AV44GXV1 = 1;
         while ( AV44GXV1 <= AV23SDTAddressHistory.Count )
         {
            AV23SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV23SDTAddressHistory.Item(AV44GXV1));
      ...
      {
         AV44GXV1 = (int)(nGXsfl_29_idx+ADDRESSGRID_nFirstRecordOnPage);
         if ( ( AV44GXV1 > 0 ) && ( AV23SDTAddressHistory.Count >= AV44GXV1 ) )
         {
            AV23SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV23SDTAddressHistory.Item(AV44GXV1));
         }
      ...
      protected void S112( )
      {
         ...
         AV52GXV9 = 1;
         while ( AV52GXV9 <= AV22sdt_addressessRec.Count )
         {
            AV36one_address = ((GeneXus.Programs.nbitcoin.SdtSDT_Addressess_SDT_AddressessItem)AV22sdt_addressessRec.Item(AV52GXV9));
         ...
         AV53GXV10 = 1;
         while ( AV53GXV10 <= AV21sdt_addressessChange.Count )
         {
            AV36one_address = ((GeneXus.Programs.nbitcoin.SdtSDT_Addressess_SDT_AddressessItem)AV21sdt_addressessChange.Item(AV53GXV10));
            AV28transactions__postInput.gxTpr_Sdt_addressess.gxTpr_Address.Add(AV36one_address.gxTpr_Address, 0);
            AV38allAddressess.Add(AV36one_address, 0);
         ...
         AV54GXV11 = 1;
         while ( AV54GXV11 <= AV37StoredTransactions.gxTpr_Transaction.Count )
         {
            AV43TransactionItem = ((GeneXus.Programs.wallet.SdtStoredTransactions_TransactionItem)AV37StoredTransactions.gxTpr_Transaction.Item(AV54GXV11));
         ...
         AssignAttri(sPrefix, false, "AV32recevingAddress", AV32recevingAddress);
         AV35addresImage = new GeneXus.Programs.qrcoder.generateqrcode(context).executeUdp(  "bitcoin:"+AV32recevingAddress);
         AssignProp(sPrefix, false, imgavAddresimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV35addresImage)) ? AV55Addresimage_GXI : context.convertURL( context.PathToRelativeUrl( AV35addresImage))), true);
         AssignProp(sPrefix, false, imgavAddresimage_Internalname, "SrcSet", context.GetImageSrcSet( AV35addresImage), true);
         GXt_char5 = "";
         new GeneXus.Programs.qrcoder.generateqrcode(context ).execute(  "bitcoin:"+AV32recevingAddress, out  GXt_char5) ;
         AV55Addresimage_GXI = GXDbFile.PathToUrl( GXt_char5, context);
         AssignProp(sPrefix, false, imgavAddresimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV35addresImage)) ? AV55Addresimage_GXI : context.convertURL( context.PathToRelativeUrl( AV35addresImage))), true);
         AssignProp(sPrefix, false, imgavAddresimage_Internalname, "SrcSet", context.GetImageSrcSet( AV35addresImage), true);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202461814255541", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wallet/multyaddress.js", "?202461814255541", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"ADDRESSGRID_nEOF"},{"av":"subAddressgrid_Rows","ctrl":"ADDRESSGRID","prop":"Rows"},{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"av":"sPrefix"},{"av":"AV8error","fld":"vERROR"},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"},{"av":"AV31wallet","fld":"vWALLET","hsh":true},{"av":"AV9extKeyInfoRoot","fld":"vEXTKEYINFOROOT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV9extKeyInfoRoot","fld":"vEXTKEYINFOROOT","hsh":true},{"av":"AV31wallet","fld":"vWALLET","hsh":true},{"av":"AV27totalBalance","fld":"vTOTALBALANCE","pic":"ZZZZZZZZ9.99999999"},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"ctrl":"SEND","prop":"Visible"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"},{"av":"AV32recevingAddress","fld":"vRECEVINGADDRESS"},{"av":"AV35addresImage","fld":"vADDRESIMAGE"},{"av":"AV8error","fld":"vERROR"}]}""");
         setEventMetadata("ADDRESSGRID.LOAD","""{"handler":"E15092","iparms":[{"av":"AV31wallet","fld":"vWALLET","hsh":true},{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29}]""");
         ...
         setEventMetadata("'GET KEY INFO'","""{"handler":"E16092","iparms":[{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29}]}""");
         setEventMetadata("'UPDATE BALANCE'","""{"handler":"E12092","iparms":[{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"},{"av":"AV31wallet","fld":"vWALLET","hsh":true},{"av":"AV9extKeyInfoRoot","fld":"vEXTKEYINFOROOT","hsh":true},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"av":"ADDRESSGRID_nEOF"},{"av":"subAddressgrid_Rows","ctrl":"ADDRESSGRID","prop":"Rows"},{"av":"sPrefix"},{"av":"AV8error","fld":"vERROR"}]""");
         setEventMetadata("'UPDATE BALANCE'",""","oparms":[{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"av":"AV27totalBalance","fld":"vTOTALBALANCE","pic":"ZZZZZZZZ9.99999999"},{"av":"AV8error","fld":"vERROR"},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"ctrl":"SEND","prop":"Visible"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"},{"av":"AV32recevingAddress","fld":"vRECEVINGADDRESS"},{"av":"AV35addresImage","fld":"vADDRESIMAGE"}]}""");
         setEventMetadata("'SEND'","""{"handler":"E11091","iparms":[]}""");
         setEventMetadata("GX.EXTENSIONS.WEB.POPUP.ONPOPUPCLOSED","""{"handler":"E13092","iparms":[{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"ADDRESSGRID_nEOF"},{"av":"subAddressgrid_Rows","ctrl":"ADDRESSGRID","prop":"Rows"},{"av":"AV8error","fld":"vERROR"},{"av":"AV31wallet","fld":"vWALLET","hsh":true},{"av":"AV9extKeyInfoRoot","fld":"vEXTKEYINFOROOT","hsh":true},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"},{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"av":"sPrefix"},{"av":"AV19PopupName","fld":"vPOPUPNAME"}]""");
         setEventMetadata("GX.EXTENSIONS.WEB.POPUP.ONPOPUPCLOSED",""","oparms":[{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"av":"AV27totalBalance","fld":"vTOTALBALANCE","pic":"ZZZZZZZZ9.99999999"},{"av":"AV8error","fld":"vERROR"},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"ctrl":"SEND","prop":"Visible"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"},{"av":"AV32recevingAddress","fld":"vRECEVINGADDRESS"},{"av":"AV35addresImage","fld":"vADDRESIMAGE"},{"av":"AV9extKeyInfoRoot","fld":"vEXTKEYINFOROOT","hsh":true},{"av":"AV31wallet","fld":"vWALLET","hsh":true}]}""");
         setEventMetadata("ADDRESSGRID_FIRSTPAGE","""{"handler":"subaddressgrid_firstpage","iparms":[{"av":"ADDRESSGRID_nFirstRecordOnPage"},{"av":"ADDRESSGRID_nEOF"},{"av":"subAddressgrid_Rows","ctrl":"ADDRESSGRID","prop":"Rows"},{"av":"AV23SDTAddressHistory","fld":"vSDTADDRESSHISTORY","grid":29},{"av":"nGXsfl_29_idx","ctrl":"GRID","prop":"GridCurrRow","grid":29},{"av":"nRC_GXsfl_29","ctrl":"ADDRESSGRID","prop":"GridRC","grid":29},{"av":"sPrefix"},{"av":"AV8error","fld":"vERROR"},{"av":"AV31wallet","fld":"vWALLET","hsh":true},{"av":"AV9extKeyInfoRoot","fld":"vEXTKEYINFOROOT","hsh":true},{"av":"AV37StoredTransactions","fld":"vSTOREDTRANSACTIONS"},{"av":"AV7deserializedExtPubKey","fld":"vDESERIALIZEDEXTPUBKEY"},{"av":"AV28transactions__postInput","fld":"vTRANSACTIONS__POSTINPUT"}]""");
      ...
      private string AV55Addresimage_GXI ;

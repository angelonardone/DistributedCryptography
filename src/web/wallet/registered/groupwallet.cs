...
namespace GeneXus.Programs.wallet.registered {
   public class groupwallet : GXWebComponent
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "ADDRESSGRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "'GET KEY INFO'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "'GET KEY INFO'") == 0 ) )
                           {
                              ...
                              AV75GXV1 = (int)(nGXsfl_27_idx+ADDRESSGRID_nFirstRecordOnPage);
                              if ( ( AV25SDTAddressHistory.Count >= AV75GXV1 ) && ( AV75GXV1 > 0 ) )
                              {
                                 AV25SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV25SDTAddressHistory.Item(AV75GXV1));
      ...
      protected void STRUP1S0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            while ( nGXsfl_27_fel_idx < nRC_GXsfl_27 )
            {
               ...
               AV75GXV1 = (int)(nGXsfl_27_fel_idx+ADDRESSGRID_nFirstRecordOnPage);
               if ( ( AV25SDTAddressHistory.Count >= AV75GXV1 ) && ( AV75GXV1 > 0 ) )
               {
                  AV25SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV25SDTAddressHistory.Item(AV75GXV1));
                  AV73gridRecevingAddress = cgiGet( edtavGridrecevingaddress_Internalname);
      ...
      private void E151S2( )
      {
         ...
         returnInSub = false;
         AV75GXV1 = 1;
         while ( AV75GXV1 <= AV25SDTAddressHistory.Count )
         {
            AV25SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV25SDTAddressHistory.Item(AV75GXV1));
      ...
      {
         AV75GXV1 = (int)(nGXsfl_27_idx+ADDRESSGRID_nFirstRecordOnPage);
         if ( ( AV75GXV1 > 0 ) && ( AV25SDTAddressHistory.Count >= AV75GXV1 ) )
         {
            AV25SDTAddressHistory.CurrentItem = ((GeneXus.Programs.wallet.SdtSDTAddressHistory)AV25SDTAddressHistory.Item(AV75GXV1));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202532417461797", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wallet/registered/groupwallet.js", "?202532417461797", false, true);

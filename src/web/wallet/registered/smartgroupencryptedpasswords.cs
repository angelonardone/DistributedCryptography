...
namespace GeneXus.Programs.wallet.registered {
   public class smartgroupencryptedpasswords : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20251011434256", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wallet/registered/smartgroupencryptedpasswords.js", "?20251011434257", false, true);

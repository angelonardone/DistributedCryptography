...
namespace GeneXus.Programs.wallet.registered {
   public class deriveaddresssfordelegationmusig : GXProcedure
   {
      public deriveaddresssfordelegationmusig( )
      {
      ...
      public deriveaddresssfordelegationmusig( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            GXt_char1 = AV18error;
            new GeneXus.Programs.wallet.registered.deriveoneaddressfordelegationmusig(context ).execute(  AV22group_sdt,  AV41networkType,  AV46generatedType,  AV47sequence, out  AV42oneAddress, out  GXt_char1) ;
            AV18error = GXt_char1;

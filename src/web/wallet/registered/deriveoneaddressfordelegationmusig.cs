...
namespace GeneXus.Programs.wallet.registered {
   public class deriveoneaddressfordelegationmusig : GXProcedure
   {
      public deriveoneaddressfordelegationmusig( )
      {
      ...
      public deriveoneaddressfordelegationmusig( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV13error)) )
         {
            ...
            while ( AV42GXV1 <= AV21group_sdt.gxTpr_Contact.Count )
            {
               ...
               if ( ( AV21group_sdt.gxTpr_Grouptype == 200 ) && ! ( AV24oneContact.gxTpr_Contactid == AV24oneContact.gxTpr_Contactgroupid ) )
               {

...
namespace GeneXus.Programs.wallet.registered {
   public class delegationmyltisigallsignatures : GXWebComponent
   {
      ...
      protected void gxgrGridsignatures_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV5group_sdt);
         sPrefix = GetPar( "sPrefix");
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vGROUP_SDT", AV5group_sdt);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vGROUP_SDT", GetSecureSignedToken( sPrefix, AV5group_sdt, context));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void gxgrGridsignatures_refresh( int subGridsignatures_Rows ,
                                                 ...
                                                 GeneXus.Programs.wallet.registered.SdtGroup_SDT AV5group_sdt ,
                                                 string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541513132118", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wallet/registered/delegationmyltisigallsignatures.js", "?202541513132119", false, true);

...
namespace GeneXus.Programs.wallet.registered {
   public class votemultisignature : GXWebComponent
   {
      public votemultisignature( )
      {
      ...
      public votemultisignature( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Vote based Multi Signature") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wallet.registered.votemultisignature.aspx") +"\">") ;
      ...
      {
         return "Wallet.registered.VoteMultiSignature" ;
      }

      public override string GetPgmdesc( )
      {
         return "Vote based Multi Signature" ;
      }
      ...
      protected void WB1N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wallet.registered.votemultisignature.aspx");
            }
            ...
            GxWebStd.gx_single_line_edit( context, edtavCtlminimumshares_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13group_sdt.gxTpr_Minimumshares), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13group_sdt.gxTpr_Minimumshares), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,8);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtlminimumshares_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCtlminimumshares_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Wallet/registered/VoteMultiSignature.htm");
         ...
         if ( wbEnd == 11 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttSave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(11), 2, 0)+","+"null"+");", "Save", bttSave_Jsonclick, 5, "Save", "", StyleString, ClassString, bttSave_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'SAVE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/registered/VoteMultiSignature.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void START1N2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Vote based Multi Signature", 0) ;
            context.wjLoc = "";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wallet\\registered\\votemultisignature", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481313332048", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wallet/registered/votemultisignature.js", "?202481313332049", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'SAVE'","""{"handler":"E121N2","iparms":[{"av":"AV13group_sdt","fld":"vGROUP_SDT"},{"av":"AV30totalUserShares","fld":"vTOTALUSERSHARES","pic":"ZZZ9"},{"av":"AV20hasContactEmptyShares","fld":"vHASCONTACTEMPTYSHARES"},{"av":"AV18groupContacts","fld":"vGROUPCONTACTS","grid":11},{"av":"nGXsfl_11_idx","ctrl":"GRID","prop":"GridCurrRow","grid":11},{"av":"GRIDCONTACTS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_11","ctrl":"GRIDCONTACTS","prop":"GridRC","grid":11},{"av":"AV32saveAndReturn","fld":"vSAVEANDRETURN"}]""");
         ...
         setEventMetadata("'CANCEL EDIT'","""{"handler":"E131N2","iparms":[]}""");
         setEventMetadata("'ADD A CONTACT'","""{"handler":"E111N1","iparms":[]}""");
         setEventMetadata("GRIDCONTACTS.LOAD","""{"handler":"E181N2","iparms":[{"av":"AV13group_sdt","fld":"vGROUP_SDT"},{"av":"AV18groupContacts","fld":"vGROUPCONTACTS","grid":11},{"av":"nGXsfl_11_idx","ctrl":"GRID","prop":"GridCurrRow","grid":11},{"av":"GRIDCONTACTS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_11","ctrl":"GRIDCONTACTS","prop":"GridRC","grid":11}]""");
         ...
         setEventMetadata("'ACTIVATE GROUP'","""{"handler":"E161N2","iparms":[{"av":"AV13group_sdt","fld":"vGROUP_SDT"},{"av":"AV30totalUserShares","fld":"vTOTALUSERSHARES","pic":"ZZZ9"},{"av":"AV20hasContactEmptyShares","fld":"vHASCONTACTEMPTYSHARES"},{"av":"AV18groupContacts","fld":"vGROUPCONTACTS","grid":11},{"av":"nGXsfl_11_idx","ctrl":"GRID","prop":"GridCurrRow","grid":11},{"av":"GRIDCONTACTS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_11","ctrl":"GRIDCONTACTS","prop":"GridRC","grid":11},{"av":"AV10error","fld":"vERROR"},{"av":"AV22message_signature","fld":"vMESSAGE_SIGNATURE"},{"av":"AV26sdt_message","fld":"vSDT_MESSAGE"}]""");

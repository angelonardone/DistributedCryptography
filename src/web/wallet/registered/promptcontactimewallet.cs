...
namespace GeneXus.Programs.wallet.registered {
   public class promptcontactimewallet : GXDataArea
   {
      public promptcontactimewallet( )
      {
      ...
      public promptcontactimewallet( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wallet.registered.promptcontactimewallet") +"\">") ;
      ...
      {
         return formatLink("wallet.registered.promptcontactimewallet")  ;
      }

      public override string GetPgmname( )
      {
         return "Wallet.registered.PromptContacTimeWallet" ;
      }
      ...
      protected void WB2T0( )
      {
         ...
         if ( wbEnd == 6 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttClose_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(6), 1, 0)+","+"null"+");", "Close", bttClose_Jsonclick, 5, "Close", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CLOSE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/registered/PromptContacTimeWallet.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257179275248", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/registered/promptcontactimewallet.js", "?20257179275248", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Prompt Contac Time Wallet";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }

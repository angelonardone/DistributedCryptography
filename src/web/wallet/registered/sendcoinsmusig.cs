...
namespace GeneXus.Programs.wallet.registered {
   public class sendcoinsmusig : GXHttpHandler
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255213174824", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/registered/sendcoinsmusig.js", "?20255213174824", false, true);

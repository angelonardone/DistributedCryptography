...
namespace GeneXus.Programs.wallet.registered {
   public class promptcontac : GXDataArea
   {
      ...
      {
         ajax_req_read_hidden_sdt(GetNextPar( ), AV6allContacts);
         ...
         gxgrContactgrid_refresh( AV6allContacts, AV27wallet) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wallet.registered.promptcontac.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vALLCONTACTS", GetSecureSignedToken( "", AV6allContacts, context));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_Allcontacts", GetSecureSignedToken( "", AV6allContacts, context));
      ...
      {
         return formatLink("wallet.registered.promptcontac.aspx")  ;
      }
      ...
      protected void gxgrContactgrid_refresh( GXBaseCollection<GeneXus.Programs.wallet.registered.SdtContact_SDT> AV6allContacts ,
                                              GeneXus.Programs.wallet.SdtWallet AV27wallet )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavCtluserprivatename1_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavCtluserprivatename1_Enabled), 5, 0), !bGXsfl_6_Refreshing);
         edtavCtlusername1_Enabled = 0;
         AssignProp("", false, edtavCtlusername1_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavCtlusername1_Enabled), 5, 0), !bGXsfl_6_Refreshing);
         edtavSelectcontact_Enabled = 0;
         AssignProp("", false, edtavSelectcontact_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSelectcontact_Enabled), 5, 0), !bGXsfl_6_Refreshing);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202462512534651", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/registered/promptcontac.js", "?202462512534652", false, true);
      ...
      protected void sendrow_62( )
      {
         ...
         /* Single line edit */
         TempTags = " " + ((edtavSelectcontact_Enabled!=0)&&(edtavSelectcontact_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 9,'',false,'"+sGXsfl_6_idx+"',6)\"" : " ");
         ROClassString = "Attribute";
         ContactgridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSelectcontact_Internalname,StringUtil.RTrim( AV25selectContact),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavSelectcontact_Enabled!=0)&&(edtavSelectcontact_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,9);\"" : " "),"'"+""+"'"+",false,"+"'"+"E\\'SELECT CONTACT\\'."+sGXsfl_6_idx+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSelectcontact_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtavSelectcontact_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)6,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"CONTACTGRID_nFirstRecordOnPage"},{"av":"CONTACTGRID_nEOF"},{"av":"AV6allContacts","fld":"vALLCONTACTS","grid":6,"hsh":true},{"av":"nGXsfl_6_idx","ctrl":"GRID","prop":"GridCurrRow","grid":6},{"av":"nRC_GXsfl_6","ctrl":"CONTACTGRID","prop":"GridRC","grid":6},{"av":"AV27wallet","fld":"vWALLET","hsh":true}]}""");
         setEventMetadata("CONTACTGRID.LOAD","""{"handler":"E131K2","iparms":[]""");
         setEventMetadata("CONTACTGRID.LOAD",""","oparms":[{"av":"AV25selectContact","fld":"vSELECTCONTACT"}]}""");
         setEventMetadata("'SELECT CONTACT'","""{"handler":"E141K2","iparms":[{"av":"AV6allContacts","fld":"vALLCONTACTS","grid":6,"hsh":true},{"av":"nGXsfl_6_idx","ctrl":"GRID","prop":"GridCurrRow","grid":6},{"av":"CONTACTGRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_6","ctrl":"CONTACTGRID","prop":"GridRC","grid":6},{"av":"AV27wallet","fld":"vWALLET","hsh":true}]}""");
      ...
      private int edtavSelectcontact_Visible ;

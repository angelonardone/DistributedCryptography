...
namespace GeneXus.Programs.wallet {
   public class showauthenticatopin : GXDataArea
   {
      public showauthenticatopin( )
      {
      ...
      public showauthenticatopin( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wallet.showauthenticatopin.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ShowAuthenticatoPin");
         ...
         GXUtil.WriteLogInfo("wallet\\showauthenticatopin:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("wallet.showauthenticatopin.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Wallet.ShowAuthenticatoPin" ;
      }

      public override string GetPgmdesc( )
      {
         return "Show Authenticato Pin" ;
      }
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgavQrcode_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, AV10qrcode_IsBlob, false, context.GetImageSrcSet( sImgUrl), "HLP_Wallet/ShowAuthenticatoPin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttRefreshpin_Internalname, "", "Refresh PIN", bttRefreshpin_Jsonclick, 5, "Refresh PIN", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'REFRESH PIN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ShowAuthenticatoPin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttClose_Internalname, "", "Close", bttClose_Jsonclick, 5, "Close", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CLOSE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ShowAuthenticatoPin.htm");
      ...
      protected void STRUP0U0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLogError("wallet\\showauthenticatopin:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202461814262648", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/showauthenticatopin.js", "?202461814262648", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Show Authenticato Pin";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GXV1","fld":"CTLISSUER1"},{"av":"GXV2","fld":"CTLACCOUNTTITLE1"}]}""");
         setEventMetadata("'REFRESH PIN'","""{"handler":"E120U2","iparms":[{"av":"AV5authenticator","fld":"vAUTHENTICATOR"}]""");
         setEventMetadata("'REFRESH PIN'",""","oparms":[{"av":"AV8generatedPIN","fld":"vGENERATEDPIN"}]}""");

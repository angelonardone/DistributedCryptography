...
namespace GeneXus.Programs.wallet {
   public class approvespending : GXDataArea
   {
      public approvespending( )
      {
      ...
      public approvespending( IGxContext context )
      {
      ...
      protected void WB1V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavPassword_Internalname, StringUtil.RTrim( AV12password), StringUtil.RTrim( context.localUtil.Format( AV12password, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,8);\""+" "+"data-gx-password-reveal"+" ", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPassword_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavPassword_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, -1, 0, 0, 0, 0, -1, true, "", "start", true, "", "HLP_Wallet/ApproveSpending.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttEnter_Internalname, "", "Confirm", bttEnter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ApproveSpending.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E111V2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV11keyInfo.gxTpr_Privatekey)) && String.IsNullOrEmpty(StringUtil.RTrim( AV9extKeyInfo.gxTpr_Privatekey)) )
         {
            ...
            if ( ( StringUtil.StrCmp(AV13wallet.gxTpr_Wallettype, "BrainWallet") == 0 ) || ( StringUtil.StrCmp(AV13wallet.gxTpr_Wallettype, "ImportedWIF") == 0 ) )
            {
               ...
               AV6error = GXt_char2;
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV6error)) || String.IsNullOrEmpty(StringUtil.RTrim( AV11keyInfo.gxTpr_Privatekey)) )
               {
            ...
            else
            {
               ...
               AV6error = GXt_char2;
               if ( AV13wallet.gxTpr_Useauthenticator )
               {
                  AV16extendeSecretAndAuthenticator.FromJSonString(AV5clearText, null);
                  AV8extKeyCreate.gxTpr_Extendedprivatekey = AV16extendeSecretAndAuthenticator.gxTpr_Extencryptedsecret;
               }
               else
               {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV9extKeyInfo", AV9extKeyInfo);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024111513324598", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/approvespending.js", "?202411151332460", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV6error = "";
         AV5clearText = "";
         AV16extendeSecretAndAuthenticator = new GeneXus.Programs.wallet.SdtExtendeSecretAndAuthenticator(context);
         GXt_char2 = "";
      ...
      private GeneXus.Programs.wallet.SdtExtendeSecretAndAuthenticator AV16extendeSecretAndAuthenticator ;

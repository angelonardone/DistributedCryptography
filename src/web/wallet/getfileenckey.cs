...
namespace GeneXus.Programs.wallet {
   public class getfileenckey : GXProcedure
   {
      public getfileenckey( )
      {
      ...
      public getfileenckey( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV9keyInfo.FromJSonString(AV8WebSession.Get("FileEncKey"), null);
         this.cleanup();
      }

...
namespace GeneXus.Programs.wallet {
   public class approvegroupactivation : GXDataArea
   {
      public approvegroupactivation( )
      {
      ...
      public approvegroupactivation( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wallet.approvegroupactivation.aspx") +"\">") ;
      ...
      {
         return formatLink("wallet.approvegroupactivation.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Wallet.ApproveGroupActivation" ;
      }

      public override string GetPgmdesc( )
      {
         return "Approve Group Activation" ;
      }
      ...
      protected void WB1Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavPassword_Internalname, StringUtil.RTrim( AV13password), StringUtil.RTrim( context.localUtil.Format( AV13password, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,8);\""+" "+"data-gx-password-reveal"+" ", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPassword_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavPassword_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, -1, 0, 0, 0, 0, -1, true, "", "start", true, "", "HLP_Wallet/ApproveGroupActivation.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttEnter_Internalname, "", "Confirm", bttEnter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Wallet/ApproveGroupActivation.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STRUP1Z0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13password = cgiGet( edtavPassword_Internalname);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024111513324638", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wallet/approvegroupactivation.js", "?2024111513324638", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Approve Group Activation";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E111Z2","iparms":[{"av":"AV11keyCreate","fld":"vKEYCREATE"},{"av":"AV13password","fld":"vPASSWORD"},{"av":"AV9extKeyCreate","fld":"vEXTKEYCREATE"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV11keyCreate","fld":"vKEYCREATE"},{"av":"AV9extKeyCreate","fld":"vEXTKEYCREATE"}]}""");
         return  ;
      }

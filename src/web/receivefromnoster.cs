...
namespace GeneXus.Programs {
   public class receivefromnoster : GXProcedure
   {
      public receivefromnoster( )
      {
      ...
      public receivefromnoster( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         ClassLoader.Execute("areceivefromnoster","GeneXus.Programs","areceivefromnoster", new Object[] {context }, "execute", args);

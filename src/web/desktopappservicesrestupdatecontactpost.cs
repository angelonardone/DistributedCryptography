...
namespace GeneXus.Programs {
   public class desktopappservicesrestupdatecontactpost : GXProcedure
   {
      public desktopappservicesrestupdatecontactpost( )
      {
      ...
      public desktopappservicesrestupdatecontactpost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtupdateContact__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtupdateContact__postOutput aP3_updateContact__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV22updateContact__postOutputOUT = new SdtupdateContact__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_updateContact__postOutputOUT=this.AV22updateContact__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_updateContact__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV12localVarPath = "/updateContact";
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV22updateContact__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV22updateContact__postOutputOUT = new SdtupdateContact__postOutput(context);
      ...
      private SdtupdateContact__postInput AV8body ;
      private SdtupdateContact__postOutput AV22updateContact__postOutputOUT ;
      ...
      private SdtupdateContact__postOutput aP3_updateContact__postOutputOUT ;

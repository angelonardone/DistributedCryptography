...
namespace GeneXus.Programs {
   public class desktopappservicesrestgetusergroupsget : GXProcedure
   {
      public desktopappservicesrestgetusergroupsget( )
      {
      ...
      public desktopappservicesrestgetusergroupsget( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           ...
                           out SdtgetUserGroups__getOutput aP2_getUserGroups__getOutputOUT ,
                           ...
                           out bool aP4_IsSuccess )
      {
         ...
         this.AV9getUserGroups__getOutputOUT = new SdtgetUserGroups__getOutput(context) ;
         this.AV20HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV19IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP2_getUserGroups__getOutputOUT=this.AV9getUserGroups__getOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP3_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_oAuthGXGAM, out aP2_getUserGroups__getOutputOUT, out aP3_HttpMessage, out aP4_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV11localVarPath = "/getUserGroups";
         ...
         if ( AV15localVarStatusCode == 200 )
         {
            ...
            AV9getUserGroups__getOutputOUT.FromJSonString(AV14localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV9getUserGroups__getOutputOUT = new SdtgetUserGroups__getOutput(context);
      ...
      private SdtgetUserGroups__getOutput AV9getUserGroups__getOutputOUT ;
      ...
      private SdtgetUserGroups__getOutput aP2_getUserGroups__getOutputOUT ;

...
namespace GeneXus.Programs {
   public class desktopappservicesrestsendmesagepost : GXProcedure
   {
      public desktopappservicesrestsendmesagepost( )
      {
      ...
      public desktopappservicesrestsendmesagepost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtsendMesage__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtsendMesage__postOutput aP3_sendMesage__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV10sendMesage__postOutputOUT = new SdtsendMesage__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_sendMesage__postOutputOUT=this.AV10sendMesage__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_sendMesage__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV10sendMesage__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV10sendMesage__postOutputOUT = new SdtsendMesage__postOutput(context);
      ...
      private SdtsendMesage__postInput AV8body ;
      private SdtsendMesage__postOutput AV10sendMesage__postOutputOUT ;
      ...
      private SdtsendMesage__postOutput aP3_sendMesage__postOutputOUT ;

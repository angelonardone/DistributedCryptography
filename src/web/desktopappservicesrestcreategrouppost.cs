...
namespace GeneXus.Programs {
   public class desktopappservicesrestcreategrouppost : GXProcedure
   {
      public desktopappservicesrestcreategrouppost( )
      {
      ...
      public desktopappservicesrestcreategrouppost( IGxContext context )
      {
      ...
      public void execute( GXProperties aP0_ServerUrlTemplatingVar ,
                           SdtcreateGroup__postInput aP1_body ,
                           string aP2_oAuthGXGAM ,
                           out SdtcreateGroup__postOutput aP3_createGroup__postOutputOUT ,
                           ...
                           out bool aP5_IsSuccess )
      {
         ...
         this.AV10createGroup__postOutputOUT = new SdtcreateGroup__postOutput(context) ;
         this.AV21HttpMessage = new GeneXus.Utils.SdtMessages_Message(context) ;
         this.AV20IsSuccess = false ;
         initialize();
         ExecuteImpl();
         aP3_createGroup__postOutputOUT=this.AV10createGroup__postOutputOUT;
      ...
      public bool executeUdp( GXProperties aP0_ServerUrlTemplatingVar ,
                              ...
                              out GeneXus.Utils.SdtMessages_Message aP4_HttpMessage )
      {
         execute(aP0_ServerUrlTemplatingVar, aP1_body, aP2_oAuthGXGAM, out aP3_createGroup__postOutputOUT, out aP4_HttpMessage, out aP5_IsSuccess);
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV16localVarStatusCode == 200 )
         {
            ...
            AV10createGroup__postOutputOUT.FromJSonString(AV15localVarResponse.gxTpr_Content, null);
         }
      ...
      {
         AV10createGroup__postOutputOUT = new SdtcreateGroup__postOutput(context);
      ...
      private SdtcreateGroup__postInput AV8body ;
      private SdtcreateGroup__postOutput AV10createGroup__postOutputOUT ;
      ...
      private SdtcreateGroup__postOutput aP3_createGroup__postOutputOUT ;

...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="GxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item" , Namespace="distributedcryptography" )]
	[Serializable]
	...
	[DataContract(Name=@"GxExplorer_services_TxoutFromAddresses_Transaction_Used_UsedTo_Item", Namespace="distributedcryptography")]

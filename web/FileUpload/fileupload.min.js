/*
 * FileUpload GeneXus User Control 0.0.0.187820
 *
...
maxFileSize:this.MaxFileSize,getFilesFromResponse:function(a){for(var b,c=0;c<a.result.files.length;c++)b=a.result.files[c],b._index=f.length,f.push(b);return a.result.files},messages:{maxNumberOfFiles:gx.getMessage("GXM_fileupload_maxNumberOfFiles"),acceptFileTypes:gx.getMessage("GXM_fileupload_acceptFileTypes"),maxFileSize:gx.getMessage("GXM_fileupload_maxFileSize")},showCancelDownloadButton:this.EnableUploadedFileCanceling,autoDisableAdd:this.AutoDisableAddingFiles};0<this.MaxNumberOfFiles&&(l.maxNumberOfFiles=
